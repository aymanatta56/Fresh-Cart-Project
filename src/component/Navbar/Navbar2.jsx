...
function handelLogout(){
  ...
  return (
    <Navbar className="bg-gray-200 fixed w-full z-20 top-0 start-0 border-b border-default ">
      <NavbarBrand className=" container mx-auto flex flex-wrap flex-col md:flex-row items-center justify-between  p-2">
...
: <>   <li className='relative after:absolute after:w-full after:h-[1px] after:left-0 after:bottom-0 after:bg-green-500 after:scale-x-0 hover:after:scale-x-100 after:origin-right hover:after:origin-left after:transition-transform after:duration-300'  >
      ...
      <NavbarToggle className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-body rounded-base md:hidden cursor-pointer  hover:text-heading focus:outline-none focus:ring-2 focus:ring-neutral-tertiary" />
    </div>
      </NavbarBrand>
